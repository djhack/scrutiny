...
$sph_messages =  array(
  ...
  "resultsPerPage" => "výsledkov na stránku",
    ...
    "New_window" => "Navštíviť v novom okne.",	
        ...
        "SubmitHeadline" => "Môžte použiť tento formulár na navrhnutie novej stránky, ktorá by mala byť indexovaná naším vyhľadávačom.",
        ...
        "notitle"   => "Pre túto stránku nie je povolený meta názov",
        "nodes"     => "Pre túto stránku nie je povolený meta popis",
        "MainURL"   => "Hlavná URL",
        "Resfor"    => "Výsledky pre",
        "from"      => "od",
        "First"     => "First",
